...
app.get('/', function(request, respons) {
	respons.sendFile(__dirname + '/www/index.html');
});

app.get('/premium-buy', function(request, respons) {
	respons.sendFile(__dirname + '/www/premium.html');
});

app.get('/register', function(request, respons) {
	respons.sendFile(__dirname + '/www/register.html');
});
